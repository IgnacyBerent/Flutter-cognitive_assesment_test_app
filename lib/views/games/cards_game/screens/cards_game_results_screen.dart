...
class CardsGameResultsScreen extends ConsumerWidget {
  const CardsGameResultsScreen({super.key});
          ...
          MyTextButton(
            ...
            onPressed: () async {
              ...
              Navigator.of(context).pushReplacement(
                MaterialPageRoute(
                  builder: (context) {
                    return const CardsGameStartScreen();
                  },
                ),
              );
            },
